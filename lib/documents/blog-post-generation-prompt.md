...
## Example of User Input
    ...
    - Before generating the content, review the sitemap for the UK site to get an updated list of published pages and articles.
      - **UK Market:** [https://kardtrust.com/sitemap.xml](https://kardtrust.com/sitemap.xml)
...
- Add at least three (3) internal links to existing pages on [https://kardtrust.com](https://kardtrust.com), choosing them according to the context of the text. (`<a>`)
