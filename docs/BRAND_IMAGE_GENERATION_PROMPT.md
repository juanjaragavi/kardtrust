...
Based on the KardTrust logo (`kardtrust-logo-dark.png`), the definitive brand
elements are:
...
KardTrust brand logo with these exact specifications:
...
KardTrust's financial services website that communicates trust, growth, and
...
_This document is maintained as part of the KardTrust design system and should
